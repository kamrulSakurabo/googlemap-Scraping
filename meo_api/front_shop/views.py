...
class SearchView(View):
    def get(self, request, api_key):
        try:
            ...
            response = requests.get(f'http://localhost:8000/api/search/{condition.api_key}/')
            ...
            if response.status_code == 200:
                ...
                try:
                    ranking_search = RankingSearch.objects.create(
                        ...
                        start_datetime=search_data['start_datetime'],
                        end_datetime=search_data['end_datetime'],
